...
// ---------------------------------------
console.log('Java Script' + " " + "is" + " " + "awesome" + " " + "I" + " " + "love" + " " + "it!");
...
console.log('Second Word: ' + exampleFirstWord + ', with length: ' + secondWordLength);
console.log('Third Word: ' + exampleFirstWord + ', with length: ' + thirdWordLength);
console.log('Fourth Word: ' + exampleFirstWord + ', with length: ' + fourthWordLength);
console.log('Fifth Word: ' + exampleFirstWord + ', with length: ' + fifthWordLength);